...
import com.liepin.oss.LiepinOssClient;
...
public class LinearModel implements ICacheAble
{
    ...
    public void save2Oss(String bucket, String modelFile, Set<Map.Entry<String, Integer>> featureIdSet,
            final double ratio) throws IOException
    {
        save2Oss(bucket, modelFile, featureIdSet, ratio, false);
    }
            ...
            final double ratio, boolean text) throws IOException
    {
        ...
        LiepinOssClient.getInstance(bucket).put(modelFile, inputStream);
